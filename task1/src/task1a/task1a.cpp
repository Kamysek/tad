...
namespace task1a {
    ...
    map<ImageID, map<string, Mat>> task1a()
    {
        ...
        for ( int iidInt = DSC_9743; iidInt != LASTIID; iidInt++ )
        {
            ...
            storage.insert(pair("translation", translationVector));
            storage.insert(pair("direction", cameraDirection));

            rotationTranslationDirection.insert(pair(iid, storage));
            ...
            file << "t" + to_string(iid) + " = [" + to_string(translationVector.at<double>(0,0)) + 
                ...
                ", " + to_string(translationVector.at<double>(0,2)) + "];" << endl;
            ...
            file << "d" + to_string(iid) + " = [" + to_string(cameraDirection.at<double>(0,0)) + 
                ...
                ", " + to_string(cameraDirection.at<double>(0,2)) + "];" << endl;
